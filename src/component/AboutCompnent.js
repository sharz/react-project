...
function About(props) {
  const RenderLeader = prop => {
    return (
      <Media>
        <Media left className="col-12 col-md-2 m-1">
          <Media object src={prop.leader.image} alt={prop.leader.name} />
        </Media>
        <Media body className="col-12 col-md-10 m-1">
          <Media heading>
            {prop.leader.name}
          </Media>
          <p>{prop.leader.designation}</p>
          <p>{prop.leader.description}</p>
        </Media>
      </Media>
    );
  };
      ...
      <div className="row row-content">
        <div className="col-12 col-md-6">
          ...
          <p>Started in 2010, Ristorante con Fusion quickly established itself as a culinary icon par excellence
            ...
            three-star Michelin chefs in the world, you never know what will arrive on your plate
